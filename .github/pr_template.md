# Pull Request Template — Capture App Backend

Please use this template to describe your change and help reviewers validate the PR quickly.

- [ ] I have performed a self-review of my code
- [ ] My code follows the project coding standards
- [ ] New and existing tests pass locally with my changes
- [ ] I have not committed secrets (check `.env` / credentials)

## Problem Statement

Explain the problem(s) this PR addresses and the impact if not fixed.
